...
class AdminController extends BaseController
{
        ...
        try {
            ...
            try {
                ...
                $result = array(
                    'response' => array(
                        'type' => 'success',
                        'message' => Lang::get('messages.register_success')
                    )
                );
            ...
            Log::error(
                $e->getMessage() . ' , Method ' . __function__ . '(' . implode(
                    ',',
                    func_get_args()
                ) . ') Data:' . print_r($data, 1)
            );
    ...
    public function properties()
    {
        $this->data['meta'] = array(
            ...
            'error' => Lang::get("messages.general"),
            'editUser' => route("admin.edit_user"),
            'propstr' => route("admin.propstr"),
            'propertiesListApi' => route("admin.propertiesListApi"),
            'gnrl' => Lang::get("messages.general"),
            'npf' => Lang::get("ui.add_property"),
            'epf' => Lang::get("ui.edit_property"),
            'ppn' => Lang::get("ui.property_name"),
