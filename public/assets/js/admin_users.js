...
var no_selected1 = document.getElementById('no_selected').dataset;
var headings_edit_user1 = document.getElementById('headings_edit_user').dataset.headings_edit_user;
var ui_delete1 = document.getElementById('ui_delete').dataset;
var ui_cancel1 = document.getElementById('ui_cancel').dataset;
...
$(document).ready(function () {
    ...
    var msgs = {
        //del_a: msgs.del_a,
        no_selected: no_selected1,
        edit_user_head: headings_edit_user1,
        delete: ui_delete1,
        cancel: ui_cancel1
    }
